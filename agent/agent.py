...
def build_agent():
    return create_agent(
        ...
        # FilesystemMiddleware removed — ls/read_file have no use in a
        # single-turn chat demo and the agent was misusing them on
        # conceptual prompts. Re-add only if Context Hub file access
        # becomes an intentional user-facing capability.
    )
