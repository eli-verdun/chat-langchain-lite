...
CONCEPTS_DB = {
    ...
    "vector databases": {
        "tagline": "Storage optimized for embedding-based semantic search.",
        "first_released": "n/a",
        "package": "n/a (integrations: langchain-pinecone, langchain-chroma, langchain-weaviate, langchain-milvus, langchain-community for FAISS)",
        "min_python": "3.10+",
        "summary": "LangChain integrates with Pinecone, Weaviate, Chroma, FAISS, and Milvus (among others) through a shared VectorStore interface. Persist document embeddings and query them with similarity or MMR search.",
        "primary_use_case": "RAG document retrieval, semantic search, and long-term agent memory.",
    },
    "embeddings": {
        "tagline": "Turn text into dense vectors for semantic comparison.",
        "first_released": "2022",
        "package": "langchain-openai, langchain-cohere, langchain-huggingface, etc.",
        "min_python": "3.10+",
        "summary": "Embeddings models implement the Embeddings interface with embed_documents and embed_query. LangChain wraps providers like OpenAI, Cohere, and HuggingFace so vector stores and retrievers can plug in interchangeably.",
        "primary_use_case": "Indexing documents for vector stores and computing semantic similarity.",
    },
    "retrievers": {
        "tagline": "Return documents relevant to a query.",
        "first_released": "2022",
        "package": "langchain, langchain-community",
        "min_python": "3.10+",
        "summary": "A Retriever exposes get_relevant_documents / ainvoke and can wrap a vector store, a keyword index, or an ensemble. Common patterns include similarity search, MMR (maximal marginal relevance), and EnsembleRetriever for hybrid retrieval.",
        "primary_use_case": "Fetching context for RAG pipelines and tool-using agents.",
    },
    "chains": {
        "tagline": "Composable sequences of calls to models, tools, and parsers.",
        "first_released": "2022",
        "package": "langchain, langchain-core",
        "min_python": "3.10+",
        "summary": "Chains are built with LCEL (LangChain Expression Language) by piping Runnables with the | operator. Every chain supports invoke, batch, stream, and async variants out of the box.",
        "primary_use_case": "Prompt | model | parser pipelines and reusable LLM workflows.",
    },
    "agents": {
        "tagline": "LLMs that decide which tools to call in a loop.",
        "first_released": "2022",
        "package": "langchain (langchain.agents)",
        "min_python": "3.10+",
        "summary": "Use create_agent to build a tool-calling agent from a model, a list of tools, and optional middleware. The agent loops on model + tool calls until it produces a final answer or hits a stop condition.",
        "primary_use_case": "Tool use, function calling, and multi-step task execution.",
    },
    "prompts": {
        "tagline": "Structured templates for LLM inputs.",
        "first_released": "2022",
        "package": "langchain-core",
        "min_python": "3.10+",
        "summary": "PromptTemplate and ChatPromptTemplate render variables into strings or chat messages. Prompts can be versioned and shared through LangSmith Prompt Hub.",
        "primary_use_case": "Reusable, parameterized prompts for chains and agents.",
    },
    "output parsers": {
        "tagline": "Turn raw LLM text into structured Python objects.",
        "first_released": "2022",
        "package": "langchain-core",
        "min_python": "3.10+",
        "summary": "Output parsers such as StrOutputParser, JsonOutputParser, and PydanticOutputParser validate and coerce model output. For tool-calling models, with_structured_output is usually preferred.",
        "primary_use_case": "Reliable structured output from LLM responses.",
    },
}
